...
from stripstream.pddl.logic.connectives import And, Not, Or
...
actions = [
  ...
  #Axiom(effect=Clear(L2), condition=ForAll([O2], Or(Equal(O, O2), Safe(O2, L2)))), # Don't need because only place
