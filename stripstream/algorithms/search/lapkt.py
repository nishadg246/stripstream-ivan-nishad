...
# TODO - LAKPT seems kind of buggy

ENV_VAR = 'LAPKT_PATH' # .../LAPKT-public/

LAPKT_PLANNERS = {
  #'bfs_f': 'agile/seq-agl-bfs-f/plan',
...
PLANNER_OUTPUT = 'sas_plan' # 'plan.ipc'
...
def lapkt(universe, search, verbose): # NOTE - doesn't support derived predicates
  ...
  command = planner_path + COMMAND%(DOMAIN_PATH, PROBLEM_PATH, PLANNER_OUTPUT)
...
# TODO - option to try and compile out axioms
