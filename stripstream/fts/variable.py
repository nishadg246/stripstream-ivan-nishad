...
# TODO - don't restrict the domain of things to be finite when specified. Make it just be initial values

class VariableType(Type): # DataType
  num = 0
  prefix = '_vtype%s'
...
class VariableSet(object):
  ...
  #def __getitem__(self, *var): # TODO - var is already always a tuple?
  #  return VarMember(self, var)
