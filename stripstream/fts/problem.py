...
# TODO - allow arbitrary logical formulation of the transition system
# TODO - see if we can allow explicitly putting pairwise equality constraints in

# class FactoredTransitionSystem(object):
#   def __init__(self, state_vars, control_vars, transition, samplers):
